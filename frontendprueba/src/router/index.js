...
// alumnos
import Alumnos from '../views/App/Alumnos/usoPersonal'
import Productos from '../views/App/Alumnos/producto'
import Carro from '../views/App/Alumnos/carro'
import cifrado from '../views/App/Alumnos/cifrado'
import Ropa from '../views/App/Alumnos/ropa'
import Tareas from '../views/App/Alumnos/tareas'
Vue.use(VueRouter)
...
const usoPersonalRoutes = (prop, mode) => [
  {
    path: 'ejercicio',
    name: prop + '.ejercicio',
    meta: { dark: mode, auth: true, name: 'ejercicio' },
    component: Alumnos
  }
]

const productoRoutes = (prop, mode) => [
  {
    path: 'inicio',
    name: prop + '.inicio',
    meta: { dark: mode, auth: true, name: 'inicio' },
    component: Productos
  }
]

const carroRoutes = (prop, mode) => [
  {
    path: 'inicio',
    name: prop + '.inicio',
    meta: { dark: mode, auth: true, name: 'inicio' },
...
const routes = [
  ...
  },
  {
    ...
    component: Layout1,
    meta: { auth: true },
    children: usoPersonalRoutes('usoPersonal')
  },
  {
    path: '/producto',
    name: 'producto',
    component: Layout1,
    meta: { auth: true },
    children: productoRoutes('producto')
  },
  {
    path: '/carro',
    name: 'carro',
  ...
  },
  {
    ...
    component: Layout1,
    meta: { auth: true },
    children: cifradoRoutes('cifrado')
  },
  {
    path: '/ropa',
    name: 'ropa',
