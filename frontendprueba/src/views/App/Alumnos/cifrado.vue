<template>
  <b-container fluid>
    <b-modal id="modal-1" ref="modal-1" title="Componente Para Cifrado">
        <h2 class="font-italic">Hola, Bienvenido!!!</h2>
        ...
        <iq-card>
          <template class="dropdown-menu">
            <form class="px-4 py-3" id="formCifrar">
                <h4 class="mx-auto font-weight-bold" style="width: 200px;">CIFRADO/ENCRIPTACION</h4>
                <div class="form-group">
                <label for="textoIn">Texto a Cifrar</label>
                ...
                <b-button variant="primary" @click="cifrarTxt()">CIFRAR</b-button>
                <b-button variant="primary" @click="resetValues()">RESET</b-button>
                </div>
                </div>
            </form>
